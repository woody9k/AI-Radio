SYSTEM_PROMPT = (
    ...
    "- Prefer these intents: TUNE, SCAN, WEATHER_TUNE, HYDROGEN_LINE_TUNE, METEOR_LISTEN, "
    "PRESET, STATUS, QUERY_STATIONS, HELP.\n"
    "- Map common phrases to intents (e.g., '104.1 FM' => TUNE with mode=WFM).\n"
    "- Special targets: hydrogen line = 1420.40575177e6 Hz. NOAA= seven channels "
    "162.4-162.55 MHz.\n"
