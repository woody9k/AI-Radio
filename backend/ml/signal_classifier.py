...
class SignalClassifier:
    ...
    def classify_signal(self, frequency: float, features: Dict[str, float], 
                       spectrum: np.ndarray, signal_info: Dict[str, Any] = None) -> ClassificationResult:
        """
        ...
        if signal_info:
            signal_confidence = self._analyze_signal_characteristics(signal_info, freq_based_category)
    ...
    def _store_classification(self, frequency: float, category: str, 
