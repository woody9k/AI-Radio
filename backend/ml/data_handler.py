...
class FeatureExtractor:
    ...
    def __init__(self):
        self.feature_names = [
            ...
            'spectral_contrast', 'tonnetz_1', 'tonnetz_2',
            'chroma_1', 'chroma_2', 'chroma_3', 'chroma_4',
            'rms_energy', 'spectral_flatness', 'spectral_rolloff'
        ]
    
    def extract_features(self, samples: np.ndarray, spectrum: np.ndarray, 
    ...
    def _extract_frequency_domain_features(self, spectrum: np.ndarray, 
                                         sample_rate: float) -> Dict[str, float]:
    ...
    def _extract_statistical_features(self, samples: np.ndarray, 
...
class DataCollector:
    ...
    def __init__(self, data_dir: str = 'data', max_samples: int = 10000):
        ...
        self.samples_buffer = deque(maxlen=max_samples)
    ...
    def add_sample(self, samples: np.ndarray, spectrum: np.ndarray, 
                   frequency: float, sample_rate: float, gain: str,
                   signals_detected: List[Dict[str, Any]] = None):
    ...
    def get_samples(self, limit: int = None, category: str = None) -> List[SignalSample]:
    ...
    def create_dataset(self, name: str, description: str, 
                      categories: List[str] = None) -> TrainingDataset:
